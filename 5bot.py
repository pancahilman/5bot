...
cl.login(token="End8E2kN7T0E8DN4sks3.TeNwPXQhe3Aupk5sB9UoyW.NSOHhgSB02X4O03zg2RNcBEO6rA92vxOw0DIg7Ee0aI=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EniyC1N3C1k49bbhsBPa.vn7DfI47ZGoonwoIl64rUG.5Id+EU5AGnfAfnqDXsFyL6f43jGu5XN+vWEMJA9JvOc=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EnZ18Qf2S1leq3tCQ57b.q/xbEOyht9UMXPlfZGL3AW.wb61RhoTlJX2J7fkQJv2CY+GBjMJgNULZzFhCwmVqcM=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="Enpm0800BQjfA3F7vIL7.L7GdrH7Fj8HbBiy9uEIyvW.xF4oYNGlbVRqaUZW2MKV8FRpmM7Gh+NDE2z4fz42RAs=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="EnpToSk8YzXjWcvvDyh2.QoVt+qYqcki2BGzvrcy4yG.uaRx+ukmzBueLRzZU0pbpLyqdxevpyhEkVx4sb8Tmbc=")
ks.loginResult()

print "login success Panca"
reload(sys)
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,"ub8ef499994243275d6f1674e98ff5d89","u90cc967742feb9facc47771907a0ccc2"]
admin=["ub8ef499994243275d6f1674e98ff5d89","u90cc967742feb9facc47771907a0ccc2"] 
...
≫ ini kontak Bosku http://line.me/ti/p/~elvenknight ≪
≫ PANCA SELF BOT PROTECT ≪
...
Idline: http://line.me/ti/p/~elvenknight""",
    "lang":"JP",
    "comment":"Trimakasih Sudah menambahkan saya sebagai teman",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup Bro")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin PancaSelfBot Yang bisa Gunain Perintah ini.")
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Cek Siapa Tukang Ngintip....")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Check dulu Bos\nBaru Ketik Cctv\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Masuk","Join all","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            ...
            elif msg.text in ["Kabor","Bye"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).sendText(msg.to,"Jangan Baper yah, Jangan Nangis")
                    msg.contentType = 13
                        ...
                        for target in targets:
                          if target in Bots:
                            ...
                            try:
                              ...
                              random.choice(KAC).sendText(msg.to,"Kok Pada Diem?\nLemah Banget Nih Room")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                kk.sendText(msg.to,"Tukang Bakso On")
